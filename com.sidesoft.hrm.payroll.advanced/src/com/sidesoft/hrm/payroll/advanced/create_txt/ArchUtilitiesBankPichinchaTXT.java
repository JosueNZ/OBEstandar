...
public class ArchUtilitiesBankPichinchaTXT extends DalBaseProcess {
  ...
  public void doExecute(ProcessBundle bundle) throws Exception {
    ...
    try {
      ...
      final String cyearid = (String) bundle.getParams().get("cYearId");
      ...
      ArchUtilitiesBankPichinchaTXTData data[] = ArchUtilitiesBankPichinchaTXTData.select(conn,
      ...
      if (data != null && data.length > 0) {
        ...
        response.setHeader("Content-Disposition",
            "attachment; filename=TransferenciaUtilidadesPichincha.txt");
        // Build txt file
        ...
        try {
          ...
          for (ArchUtilitiesBankPichinchaTXTData archUTransfData : data) {
