...
public class Rpt_PurchaseAccounting extends HttpSecureAppServlet {
  private static Logger log4j = Logger.getLogger(Rpt_PurchaseAccounting.class);
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (log4j.isDebugEnabled())
      log4j.debug("Output: Rpt_PurchaseAccounting - pdf");

    /*
     * RptPurchaseAccountingData[] data = RptPurchaseAccountingData.select(this, strDocumentId); if
     * (log4j.isDebugEnabled()) log4j.debug("data: " + (data == null ? "null" : "not null")); if
     * (data == null || data.length == 0) data = RptPurchaseAccountingData.set();
     */

    HashMap<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("DOCUMENT_ID", strDocumentId);

    String strReportName = "@basedesign@/ec/com/sidesoft/custom/inout/reports/ad_reports/Rpt_PurchaseAccounting.jrxml";
